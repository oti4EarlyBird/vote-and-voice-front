...
<div class="my-container">
    ...
    <div class="vote-buttons">
        <button type="button" class="btn btn-outline-success">찬성</button>
        <button type="button" class="btn btn-outline-danger">반대</button>
        <hr class="boldhr"><br>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.btn-outline-success')?.addEventListener('click', function(){
        ...
        agreeCount++; hasVoted=true; updateVoteDisplay();
    });
    document.querySelector('.btn-outline-danger')?.addEventListener('click', function(){
        if(hasVoted){ alert("이미 투표하셨습니다."); return; }
        disagreeCount++; hasVoted=true; updateVoteDisplay();
    });
